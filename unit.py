...
"""
The UNIT model compromise 2 VAE-GAN. In other words, the UNIT contains 2 enocder, 2 generators (decoders), 
...
def sample_images(batches_done):
    ...
    save_image(X1, "images/%s/real_A%s.png" % (opt.dataset_name, batches_done), normalize=True)
    save_image(X2, "images/%s/real_B%s.png" % (opt.dataset_name, batches_done), normalize=True)
    save_image(fake_X2, "images/%s/fake_B%s.png" % (opt.dataset_name, batches_done), normalize=True)
    save_image(fake_X1, "images/%s/fake_A%s.png" % (opt.dataset_name, batches_done), normalize=True)
